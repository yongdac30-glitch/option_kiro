...
import { LineChartOutlined, CalculatorOutlined, ExperimentOutlined, DatabaseOutlined, BugOutlined, CheckCircleOutlined, RocketOutlined, CrownOutlined, SwapOutlined, DollarOutlined, CloudServerOutlined, FundOutlined } from '@ant-design/icons';
  ...
  return (
    ...
    >
      ...
      <Space size="large">
        ...
        <Link to="/qqq-leaps" style={{ color: '#eb2f96', fontSize: 14, display: 'flex', alignItems: 'center', gap: 6, fontWeight: 600 }}>
          <FundOutlined />
          QQQ策略
        </Link>
